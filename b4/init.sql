...
CREATE USER 'geez'@'localhost' IDENTIFIED BY '334cc35b3c704593';

grant all privileges on geez.* to 'geez'@'localhost' IDENTIFIED BY '334cc35b3c704593';
